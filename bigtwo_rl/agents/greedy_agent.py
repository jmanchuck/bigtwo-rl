...
class SmartGreedyAgent(GreedyAgent):
...
def create_basic_greedy_agent(name: str = "BasicGreedy") -> GreedyAgent:
    """Create basic greedy agent that plays lowest cards first."""
    return GreedyAgent(name=name, strategy="lowest_first")


def create_aggressive_greedy_agent(name: str = "AggressiveGreedy") -> GreedyAgent:
    """Create greedy agent that tries to clear hand quickly."""
    return GreedyAgent(name=name, strategy="clear_hand")


def create_smart_greedy_agent(name: str = "SmartGreedy") -> SmartGreedyAgent:
    """Create enhanced greedy agent with sophisticated decision making."""
    return SmartGreedyAgent(name=name)