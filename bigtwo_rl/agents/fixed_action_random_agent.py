...
class FixedActionWeightedRandomAgent(BaseAgent):
...
def create_conservative_random_agent(name: str = "ConservativeRandom") -> FixedActionWeightedRandomAgent:
    """Create random agent that prefers simpler moves."""
    return FixedActionWeightedRandomAgent(
        name=name,
        single_weight=3.0,
        pair_weight=2.0,
        triple_weight=1.0,
...
def create_aggressive_random_agent(name: str = "AggressiveRandom") -> FixedActionWeightedRandomAgent:
...
def create_balanced_random_agent(name: str = "BalancedRandom") -> FixedActionRandomAgent:
    """Create standard uniform random agent."""
    return FixedActionRandomAgent(name=name)