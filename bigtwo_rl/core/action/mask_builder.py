...
from ..game import FiveCardEngine, Hand, HandType, LastFive, compute_key_and_hand_type
from .constants import OFF_1, OFF_5, OFF_PASS
from .lookups import PAIR_ID, PAIR_LUT, TRIPLE_ID, TRIPLE_LUT
...
class ActionMaskBuilder:
    ...
    def single_and_multiples(
        self, hand: Hand, last_kind: HandType | None = None, last_key: tuple | None = None,
    ) -> list[int]:
    ...
    def _generate_singles(self, hand: Hand, last_kind: HandType | None, last_key: tuple | None) -> list[int]:
    ...
    def _generate_pairs(self, hand: Hand, last_kind: HandType | None, last_key: tuple | None) -> list[int]:
    ...
    def _generate_triples(self, hand: Hand, last_kind: HandType | None, last_key: tuple | None) -> list[int]:
