...
class GameStateTracker:
    ...
    def get_simple_state_hash(self, game_env: "ToyBigTwoFullRules") -> Tuple[int, Tuple[int, ...], int, int]:
    ...
    def get_legal_moves_cached(self, game_env: "ToyBigTwoFullRules", player: int) -> List[np.ndarray]:
    ...
    def get_action_mask(self, game_env: "ToyBigTwoFullRules", current_player: int) -> np.ndarray:
