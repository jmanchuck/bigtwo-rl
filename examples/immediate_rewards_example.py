...
def compare_immediate_vs_delayed_training():
    ...
    immediate_model, immediate_dir = immediate_trainer.train(
        ...
        model_name="immediate_reward_demo"
    )
    ...
    delayed_model, delayed_dir = delayed_trainer.train(
        total_timesteps=train_steps,
        model_name="delayed_reward_demo"
    )
...
def demonstrate_custom_reward_creation():
    ...
    print(f"Loss reward (5 cards) - Conservative: {conservative.game_reward(1, 0, 5):.1f}")
...
def main():
    ...
    try:
        ...
        print("This might be due to training time - try reducing train_steps for faster demo")
